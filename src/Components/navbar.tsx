...
const Navbar = () => {
  ...
  const toggleJobsMenu = () => setIsJobsMenuOpen(!isJobsMenuOpen);
    ...
    <>
      <nav className="text-white border-b border-gray-600 py-4">
        <div className="grid grid-cols-3 items-center px-4 gap-4 w-full">
          {/* Left links */}
          <div className="flex space-x-6 col-span-1 relative">
            ...
            <div className="relative">
              ...
              {isJobsMenuOpen && (
                <div
                  ref={jobsMenuRef}
                  className="absolute left-0 mt-7 w-[800px] bg-background border rounded shadow-lg opacity-100 transition-opacity duration-200 z-10 p-4 grid grid-cols-4 gap-4"
                >
                  <div>
                    <h4 className="font-semibold text-gray-700 mb-2">Tech</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-700 mb-2">Design & Product</h4>
